...
<%@ page import="com.zhao.oa.global.Contant" %>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <c:if test="${sessionScope.employee.post==Contant.Post_BMJL || sessionScope.employee.post==Contant.Post_ZJL}">
                                <button type="submit" class="button" name="dealWay" value="${Contant.DEAALPASS}" >${Contant.DEAALPASS}</button>
                                <button type="submit" class="button" name="dealWay" value="${Contant.DEAALH}" >${Contant.DEAALH}</button>
                                <button type="submit" class="button" name="dealWay" value="${Contant.DEAALJ}" >${Contant.DEAALJ}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==Contant.Post_CW}">
                                <button type="submit" class="button" name="dealWay" value="${Contant.DEAALPAID}" >${Contant.DEAALPAID}</button>
                                </c:if>
